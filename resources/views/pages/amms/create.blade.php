                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    @endif
                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <form method="post" id="form-amm-amc" action="{{ route('demande-comptes.store') }}" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <section>
                                            <div class="form-row mb-2">
                                                ...
                                                <div class="col-3 input-group-sm">
                                                    <label for="poidsA">Poids Produit A</label>
                                                    <input type="number" required="" name="poidsA" id="poidsA" class="form-control calculproduit" />
                                                </div>
                                                <div class="col-3 input-group-sm">
                                                    <label for="totalA">Montant Produit A</label>
                                            ...
                                            <div class="form-row mb-2">
                                                ...
                                                <div class="col-3 input-group-sm">
                                                    <label for="poidsB">Poids Produit B</label>
                                                    <input type="number" name="poidsB" id="poidsB" class="form-control calculproduit" />
                                                </div>
                                                <div class="col-3 input-group-sm">
                                                    <label for="totalB">Montant Produit B</label>
                                            ...
                                            <div class="form-row mb-2">
                                                ...
                                                <div class="col-3 input-group-sm">
                                                    <label for="poidsC">Poids Produit C</label>
                                                    <input type="number" name="poidsC" id="poidsC" class="form-control calculproduit" />
                                                </div>
                                                <div class="col-3 input-group-sm">
                                                    <label for="totalC">Montant Produit C</label>
                                            ...
                                            <div class="form-row mb-2">
                                                ...
                                                <div class="col-3 input-group-sm">
                                                    <label for="poidsD">Poids Produit D</label>
                                                    <input type="number" name="poidsD" id="poidsD" class="form-control calculproduit" />
                                                </div>
                                                <div class="col-3 input-group-sm">
                                                    <label for="totalD">Montant Produit D</label>
                                            ...
                                            <div class="form-row mb-2">
                                                ...
                                                <div class="col-3 input-group-sm">
                                                    <label for="total">Montant Total Produits</label>
