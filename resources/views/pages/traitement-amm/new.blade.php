@extends('layouts.app', ['page_name' => "Nouvelle AMM",
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content">
                    ...
                    <div class="-content widget-content-area">
                        <h5>Nouvelle demande A.M.M.</h3><br>
                        <form method="post" id="form-amm-amc" action="{{ route('traitement-amm.saveamm') }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <section class="col-8">
                                        <div class="form-row mb-4">
                                            <div class="col-6 input-group-sm">
                                                ...
                                                <input type="hidden" name="idcontribuable" id="idcontribuable" class="form-control" />
                                            </div>
                                            <div class="col-6 input-group-sm">
                                                <label for="typecontribuable">Type d'usagers</label>
                                                <input readonly type="text" class="form-control" id="typecontribuable" name="typecontribuable" />
                                            </div>
                                        ...
                                        <div class="form-row mb-2">
                                            <div class="col-12 input-group-sm">
                                                ...
                                                <input required="" readonly type="text" id="raisonsociale" name="raisonsociale" class="form-control" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mb-2">
                                            <div class="col-7 input-group-sm">
                                                ...
                                                <input readonly type="text" class="form-control" id="siegesocial" name="siegesocial" />
                                            </div>
                                            <div class="col-2 input-group-sm">
                                                <label for="bp">B.P.</label>
                                                <input readonly type="text" class="form-control" id="bp" name="bp" />
                                            </div>
                                            <div class="col-3 input-group-sm">
                                                <label for="tel">Tél.</label>
                                                <input readonly type="text" class="form-control" id="tel" name="tel" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row mb-2">
                                            <div class="col-8 input-group-sm">
                                                ...
                                                <input readonly type="text" class="form-control" id="nomprenom" name="nomprenom"  />
                                            </div>
        ...
        $('body').on('blur', '#nif', function () {
            ...
            $.ajax({
                ...
                success: function(res){
                    console.log(res);
                    if (res.nb === 0) {
                        $('#msg').html('Société introuvable dans la base de la DGCC. Enregistrez-la avant svp');
                        $('#raisonsociale').val('');
                        $('#typecontribuable').val('');
                        $('#siegesocial').val('');
                        $('#bp').val('');
                        $('#tel').val('');
                        $('#nomprenom').val('');
                        ...
                        $('#msg').html('Société enregistrée à la DGCC');
                        $('#idcontribuable').val(res.data.id);
                        $('#raisonsociale').val(res.data.raisonsociale);
                        $('#typecontribuable').val(res.type);
