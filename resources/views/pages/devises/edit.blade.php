                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>Modification de devise étrangère</h4>
                                </div>
                            </div>
                        </div>
                        <div class="widget-content widget-content-area">
                            ...
                            <form method="post" action="{{ route('devises.update', $devise->id) }}">
                                ...
                                <div class="form-group row input-group-sm mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{ $devise->code }}" type="text" name="code" class="form-control form-control-sm" id="code" placeholder="Code">
                                    </div>
                                </div>
                                <div class="form-group row input-group-sm mb-4">
                                    <label for="libelle" class="col-sm-2 col-form-label col-form-label-sm">Libellé</label>
                                    <div class="col-sm-10">
                                        <input value="{{ $devise->libelle }}" type="text" name="libelle" class="form-control form-control-sm" id="libelle" placeholder="Libellé">
                                    </div>
                                </div>
