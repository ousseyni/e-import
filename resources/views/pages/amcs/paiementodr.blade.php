            ...
            <div class="col-xl-8 col-lg-8 col-sm-8  layout-spacing">
                <div class="widget-content">
                    ...
                    <div class="-content widget-content-area">
                        ...
                        <strong>Relatif à l'A.M.C N° <b>{{ $amc->getNumDemande() }}</b>  </strong><br><br>
                        <div></div>
                            <form method="post" id="form-amm-amc" action="{{ route('amc.save_paiement', $amc) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row input-group-sm mb-4">
                                    ...
                                    <input type="hidden" name="idamc" value="{{ $amc->id }}">
