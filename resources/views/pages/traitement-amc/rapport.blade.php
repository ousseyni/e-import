            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                <div class="widget-content">
                    ...
                    <div class="-content widget-content-area">
                        <h5>Rapport d'inspection - AMC N° : {{ $amc->getNumDemande() }}</h5><br>
                        <form method="post" id="form-amm-amc" action="{{ route('traitement-amc.saverapport', $amc) }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <section>
                                    <div class="form-row mb-2">
                                        <div class="col-6 input-group-sm">
                                            ...
                                            <input type="hidden" name="slugamc" value="{{ $amc->slug }}" />
                                        ...
                                        <div class="col-4 input-group-sm">
                                            ...
                                            <select required class="form-control" id="paysprov" name="paysprov">
                                                @foreach($pays_pr as $pays)
                                                    <option value="{{$pays->libelle}}" {{ ($pays->libelle == $amc->paysprov ? 'selected' : '') }} >{{$pays->libelle}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-3 input-group-sm">
                                            ...
                                            <select required class="form-control" id="modetransport" name="modetransport">
                                                @foreach($mode_t as $mode)
                                                    <option value="{{$mode->libelle}}" {{ ($mode->libelle == $amc->modetransport ? 'selected' : '') }} >{{$mode->libelle}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-row mb-2">
                                        <div class="col-6 input-group-sm">
                                            ...
                                            <input value="{{ $amc->lieudebarque }}" type="text" required name="poinentree" id="poinentree" class="form-control" />
                                        </div>
                                        <div class="col-6 input-group-sm">
                                    ...
                                    <div class="form-row mb-2">
                                        ...
                                        <div class="col-6 input-group-sm">
                                            ...
                                            <input type="number" min="0" value="{{ $amc->totalpoids }}" required name="totalqte" id="totalqte" class="form-control" />
                                        </div>
                                    </div>
                                    <hr>
                                    @if($amc->modetransport != 'Aérien')
                                        <div class="form-row mb-1">
                                            @foreach($conteneursAmc as $conteneur)
                                                <div class="col-5 input-group-sm">
                                            ...
                                            <div class="input-group repeater_item_produits" data-repeater-item>
                                                <div class="form-row mb-4">
                                                    <div class="col-4 input-group-sm">
                                                        ...
                                                        <select class="form-control" required id="idproduitamc" name="idproduitamc" onblur="getProduit(this.name, this.value)">
                                                            ...
                                                            @foreach($categorie_produits as $categorie)
                                                                <optgroup label="{{str_replace("\\","", $categorie->libelle)}}">
                                                                    @foreach($categorie->getProduits as $produit)
                                                                        @if(in_array($produit->id, $tab_pamc))
